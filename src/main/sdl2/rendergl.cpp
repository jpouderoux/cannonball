...
void gl_show_error();
#define	SHOW_ERROR //gl_show_error();
                    ...
                    int scanlines)
{
    ...
    init_shaders(src_width, src_height, scn_width, scn_height, scanlines);
...
void Render::init_shaders(unsigned texture_width, unsigned texture_height,
...
void Render::draw_frame(uint16_t* pixels)
{
    ...
    // We pageflip the SDL2 GL context here
